...
<table class="form-table">
	...
	<tr valign="top">
		...
		<td class="forminp forminp-text">
			<a class="btn btn-soft" href="https://dashboard.weglot.com/settings/exclusions#excluded-urls" target="_blank"><span
	...
	<tr valign="top">
		...
		<td class="forminp forminp-text">
			<a class="btn btn-soft" href="https://dashboard.weglot.com/settings/exclusions#excluded-blocks" target="_blank"><span
